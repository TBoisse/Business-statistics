...
from exchanges import extract_from_leboncoin, extract_from_vinted, initiate_transaction, write_transactions
...
if __name__ == "__main__":
    ...
    # Define different path (Screenshots input, annotation csv's, separation model, ...)
    ...
    # Allows to only apply preprocessing
    if args.reset:
    ...
    if args.no_statistics:
        quit()
    # Load OCR model and separation model
    ...
    # Write all transactions in a temporary dataframe before merging
    ...
    with open(tmp_path, "a") as f:
        for file in os.listdir(input_dir):
            ...
            write_transactions(f, transactions)
    # Merge temporary df and output df
